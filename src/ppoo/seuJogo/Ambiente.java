...
public class Ambiente {
    ...
    private List<Itens> itensAmbientes;
    ...
    public void addItenAmbiente(Itens item){
            itensAmbientes.add(item);
    }

    public void removerItemAmbiente(Itens item){
        itensAmbientes.remove(item);
    }

    public boolean existeItemAmbiente(String nome){
        for (Itens item : itensAmbientes) {
    ...
    public Itens getIten(String nome){
        if (existeItemAmbiente(nome)) {
            for (Itens item : itensAmbientes) {
                if (item.getNome().equals(nome)) {
                    return item;
                }
    ...
    String lista = "Itens disponiveis: \n";
    for (Itens item : itensAmbientes) {
